...
_INDUSTRY_CLASSES: dict[str, list[dict[str, str]]] = {
    ...
    "cim": [
        ...
        {"iri": "http://iec.ch/TC57/CIM100#GeneratingUnit",
         "label": "GeneratingUnit", "description": "A single or parallel combination of units normally coupled together to produce power"},
        {"iri": "http://iec.ch/TC57/CIM100#PowerTransformer",
         "label": "PowerTransformer", "description": "An electrical device consisting of two or more coupled windings for changing voltage"},
        {"iri": "http://iec.ch/TC57/CIM100#ACLineSegment",
         "label": "ACLineSegment", "description": "A segment of AC power line between two terminals"},
        {"iri": "http://iec.ch/TC57/CIM100#Analog",
         "label": "Analog", "description": "A continuous measurement of a physical quantity"},
        {"iri": "http://iec.ch/TC57/CIM100#Discrete",
         "label": "Discrete", "description": "A discrete status or integer measurement"},
        {"iri": "http://iec.ch/TC57/CIM100#Accumulator",
         "label": "Accumulator", "description": "A cumulative register of an accumulating quantity such as energy"},
    ],
    "iec-cim": [
        {"iri": "http://iec.ch/TC57/CIM100#Equipment",
         "label": "Equipment", "description": "A physical piece of electrical or network equipment"},
        {"iri": "http://iec.ch/TC57/CIM100#GeneratingUnit",
         "label": "GeneratingUnit", "description": "A single or parallel combination of units normally coupled together to produce power"},
        {"iri": "http://iec.ch/TC57/CIM100#PowerTransformer",
         "label": "PowerTransformer", "description": "An electrical device for changing voltage between coupled windings"},
        {"iri": "http://iec.ch/TC57/CIM100#ACLineSegment",
         "label": "ACLineSegment", "description": "A segment of AC power line between two terminals"},
        {"iri": "http://iec.ch/TC57/CIM100#Analog",
         "label": "Analog", "description": "A continuous measurement of a physical quantity"},
    ...
    "rami40": [
        {"iri": "https://admin-shell.io/aas/3/0/Asset",
         "label": "Asset", "description": "A physical or logical object with an Asset Administration Shell"},
        {"iri": "https://admin-shell.io/aas/3/0/Capability",
         "label": "Capability", "description": "A function or service the asset is able to perform, often from maintenance procedures"},
        {"iri": "https://admin-shell.io/aas/3/0/Submodel",
         "label": "Submodel", "description": "A structured set of properties and capabilities describing an asset aspect"},
        {"iri": "https://admin-shell.io/aas/3/0/Property",
         "label": "Property", "description": "A single-valued attribute of an asset or submodel"},
        {"iri": "https://admin-shell.io/aas/3/0/Operation",
         "label": "Operation", "description": "An executable operation offered by an asset's AAS"},
        {"iri": "https://admin-shell.io/aas/3/0/ConceptDescription",
         "label": "ConceptDescription", "description": "A concept description providing semantics for a property or operation"},
    ],
}
