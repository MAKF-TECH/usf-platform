...
async def lifespan(app: FastAPI):
    ...
    logger.info("usf-audit starting", extra={"service": settings.SERVICE_NAME})
    ...
    try:
        ...
        pass
    logger.info("usf-audit shutdown")
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="Append-only audit log, lineage tracing, PROV-O export",
        version="0.1.0",
        lifespan=lifespan,
    )
